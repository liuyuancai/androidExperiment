...
public class ExpSixthEditInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exp_sixth_edit_info);
        setTitle("编辑个人信息");
        //获取标签
        ...
        save_info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ExpSixthEditInfo.this.setResult(RESULT_OK,intent1);
                ExpSixthEditInfo.this.finish();
            }
        });
    }
